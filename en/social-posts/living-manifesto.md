...
→ [Reply directly under these posts (Giscus)](#comments)  
→ [Submit a suggestion, addition or your own text via GitHub](https://github.com/OpenInternetManifest/issues/new/choose)  
→ [Join the discussion in the Matrix room](https://matrix.to/#/#openinternetmanifest:matrix.org)  
→ [Continue reading when the next RVN goes live](/en/social-posts)
