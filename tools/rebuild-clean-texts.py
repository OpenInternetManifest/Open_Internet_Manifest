#!/usr/bin/env python3
"""
rebuild-clean-texts.py - Herbouwt official-clean-texts.js netjes uit alle posts
"""
...
def rebuild():
    ...
    for pattern in ["_social-posts/nl/day-*.md", "_social-posts/en/day-*.md"]:
        for file_path in sorted(Path(".").glob(pattern)):
            ...
            # Extract raw_markdown if available, else body
...
"""
    ...
    print(f"\n🎉 Klaar! {len(fuzzy_hashes)} entries herbouwd.")
