<div style="position: relative; margin: 2em 0; text-align: center; overflow: hidden; height: 60vh; max-height: 400px;">
  ...
  <div style="position: absolute; top: 80%; left: 50%; transform: translate(-50%, -50%); background: rgba(15,20,25,0.85); padding: 2em 3em; border-radius: 16px; max-width: 90%; width: auto;">
...
<h4 style="text-align: center; color: #e0e0e0; font-size: 1.2em margin-bottom: 2em;">
